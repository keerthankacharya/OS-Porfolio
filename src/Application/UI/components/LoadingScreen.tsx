        ...
        >
                        ...
                        <div style={styles.logoContainer}>
                            <div>
                                <p style={styles.green}>
                                    <b>keerthan-k-acharya.vercel.app</b>
                                </p>
                            </div>
                        </div>
                        <div style={styles.headerInfo}>
                            <p>Released: 01/13/2000</p>
                            <p>KKABIOS (C)2024 Keerthan K Acharya Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>KKA S13 2024 Special UC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>KKA Showcase(tm) XX 113</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Keerthan K Acharya Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Keerthan K Acharya Portfolio Showcase</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
